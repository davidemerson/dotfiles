 ...
 */
static char *font = "Berkeley Mono Variable NNIX:pixelsize=18:antialias=true:autohint=true";
#if FONT2_PATCH
/* Spare fonts */
static char *font2[] = {
...
static const char *colorname[] = {
	/* 8 normal colors — grayscale, light blue is the only accent */
	"#1a1a1a", /* 0 black */
	"#808080", /* 1 red    -> gray */
	"#a0a0a0", /* 2 green  -> gray */
	"#909090", /* 3 yellow -> gray */
	"#8fb6e0", /* 4 blue   -> light blue (accent) */
	"#888888", /* 5 magenta-> gray */
	"#959595", /* 6 cyan   -> gray */
	"#cccccc", /* 7 white */
	...
	"#c0c0c0", /* 10 */
	"#b0b0b0", /* 11 */
	"#bcd6f2", /* 12 bright blue -> light blue (accent) */
	"#a8a8a8", /* 13 */
	"#b5b5b5", /* 14 */
	"#ffffff", /* 15 */
	...
	"#8fb6e0", /* 256 -> cursor (light blue) */
	"#1f2d4d", /* 257 -> rev cursor (navy) */
	"#000000", /* 258 -> bg */
	"#cccccc", /* 259 -> fg */
};
