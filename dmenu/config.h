...
{
	"Berkeley Mono Variable NNIX:pixelsize=18:antialias=true:autohint=true"
};
#endif // PANGO_PATCH
#if MANAGED_PATCH
...
char *colors[][2] = {
	...
	[SchemeSel]  = { "#bcd6f2", "#1f2d4d" },
	[SchemeOut]  = { "#000000", "#cccccc" },
	#if BORDER_PATCH
	[SchemeBorder] = { "#000000", "#8fb6e0" },
	#endif // BORDER_PATCH
	#if MORECOLOR_PATCH
	[SchemeMid]  = { "#eeeeee", "#770000" },
	#endif // MORECOLOR_PATCH
	#if HIGHLIGHT_PATCH
	[SchemeSelHighlight]  = { "#ffffff", "#1f2d4d" },
